...
![jiagou](./doc/tradeengin_structure.png)
...
项目依赖的中间件：消息组件kafka，数据库mysql,redis，分布式事务dtm，websocket推送gpush。

1、配置一个host 映射， api.tradeengin.com:项目地址
